...
function Page() {
  ...
  const onSubmit = async (v: z.infer<typeof schema>) => {
    setLoading(true);
    try { await createFn({ data: v }); toast.success("Submitted for approval"); form.reset(); qc.invalidateQueries({ queryKey: ["admin-overview"] }); qc.invalidateQueries({ queryKey: ["admin-pending"] }); qc.invalidateQueries({ queryKey: ["admin-all-txns"] }); }
