...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium digital banking with multi-currency accounts, global transfers, and white-glove service." },
      { name: "author", content: "Crest Nova Holdings" },
      { property: "og:title", content: "Crest Nova Holdings — Premium Digital Banking" },
      { property: "og:description", content: "Premium digital banking with multi-currency accounts, global transfers, and white-glove service." },
