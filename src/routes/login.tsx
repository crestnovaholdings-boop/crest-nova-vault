...
export const Route = createFileRoute("/login")({
  head: () => ({ meta: [{ title: "Sign in — Crest Nova Holdings" }] }),
  component: LoginPage,
});
...
function LoginPage() {
  ...
  return (
    <AuthShell title="Welcome back" subtitle="Sign in to your Crest Nova account.">
      ...
      <p className="mt-6 text-sm text-center text-muted-foreground">
        New here? <Link to="/register" className="text-primary hover:underline">Open an account</Link>
      </p>
    </AuthShell>
  );
}
